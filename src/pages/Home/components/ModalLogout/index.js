...
export function ModalLogout({close}){
    ...
    return(
        <div className='flex justify-center items-center inset-0'>
            ...
            <div className='absolute flex flex-col items-center justify-center p-3 w-[300px] h-[200px] bg-[#0a4303] rounded-md mx-2 my-2 lg:my-auto lg:mx-auto inset-0 border-2'>
