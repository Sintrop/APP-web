...
export function PageSelect({atualPage, onChange, totalPages}: Props){
    ...
    return(
        <div className="flex flex-row items-center rounded-md bg-container-primary w-fit overflow-hidden">
            ...
            <div className="justify-center px-3 bg-container-secondary h-full items-center flex">
                <p className="text-white text-sm">{atualPage} de {totalPages}</p>
            </div>
            <button 
                className="w-8 h-8 items-center justify-center flex"
                onClick={nextPage}
            >
