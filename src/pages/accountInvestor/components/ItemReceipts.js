...
export function ItemReceipt({ data, index }) {
    ...
    return (
        <div className="flex flex-col w-full bg-[#03364B] rounded-md">
            ...
            {moreInfo && (
                <div className="flex flex-col p-3 w-full bg-[#012939]">
                    <div className="mt-5">
                        ...
                        <div className="w-full h-[1px] bg-[#03364B]"/>
                    ...
                    <div className="flex items-center gap-3 flex-wrap justify-center lg:justify-start">
                        <div className="flex flex-col items-center px-5 py-3 rounded-sm bg-[#1C840F] w-[135px]">
