...
export function RankingItem({data, position, researchersCenter, developersCenter, filterSelect}){
    ...
    if(filterSelect === 'reais'){
        if(data.producerWallet === '0xaC3Dd98E8025BD37Ca653f314B5CBE8492738919' || data.producerWallet === '0x566C073Ec7B0d9e9Dd1CAf58e74CB954d8cB5DEf' || data.producerWallet === '0x72482AE19928D654EB6D55f741157AE4701E3abe'){
            return(
                <div 
