...
export function ModalRequestSepolia({close}){
    ...
    return(
        <Dialog.Portal className='flex justify-center items-center inset-0'>
            ...
            <Dialog.Content className='absolute flex flex-col items-center justify-between p-3 lg:w-[400px] h-[300px] bg-green-950 rounded-md m-auto inset-0 border-2'>
                ...
                <div className="w-[380px] flex flex-col items-center">
                    ...
                    <input
                        ...
                        className='h-10 w-full bg-[#0a4303] px-2 rounded-md text-white'
