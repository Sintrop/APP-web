...
export function ModalTransactionCreated({close}){
    return(
        <div className='flex justify-center items-center inset-0'>
            ...
            <div className='absolute flex flex-col justify-between p-3 lg:w-[400px] lg:h-[500px] bg-container-primary rounded-md mx-2 my-2 lg:my-auto lg:mx-auto inset-0 border-2'>
                ...
                <div className="flex items-center justify-center flex-col gap-2">
                    <button
                        ...
                        onClick={async() => {
                            await navigator.clipboard.writeText('https://pay.sintrop.com')
